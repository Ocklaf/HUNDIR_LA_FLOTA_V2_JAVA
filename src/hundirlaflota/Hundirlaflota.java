    ...
    public static void switchCaseDificultad(int dificultadElegida, int datosJuego[]){
        ...
        switch(dificultadElegida){
            ...
            case 4://Nivel Personalizado     
                nivelPersonalizado(datosJuego, jugadorPC, jugadorHumano);
            break;
        }
    }
    
    //Aquí recogemos todos los datos y creamos el nivel personalizado, lo sacamos de la función switchCaseDificultad dada la longitud de este case
    public static void nivelPersonalizado(int datosJuego[], char jugadorPC[][], char jugadorHumano[][]){
        Scanner input = new Scanner(System.in);
        int cantidad, dimensionTablero;
        
        datosJuego[1]=0;//Iniciamos la cantidad de "misiles" a 0 para verificar que mínimo se ha introducido algún barco
